...
\begin{figure}[t]
  ...
  \caption{\label{fig:targeting}%
    ...
    median of two, against fourteen for the black-box loop, with a median of ten. The
    black box's flat first segment is its finite-difference Jacobian, which spends two
    solves without moving the iterate. Measured on the four-dimensional aligned-spin
    model over the production box of Table~\ref{tab:box}, at zero spin; every
    configuration emitted is certified to $\|R\|_\infty\le10^{-10}$.}
\end{figure}
